...
ban-banned-permanent = Бан всегда можно обжаловать. Для этого посетите https://discord.com/invite/BQHQNbuVCZ.
ban-banned-permanent-appeal = Бан всегда можно обжаловать. Для этого посетите https://discord.com/invite/BQHQNbuVCZ.
ban-expires = Вы получили бан на { $duration } минут, и он истечёт { $time } по UTC (для московского времени добавьте 3 часа).
ban-banned-1 = Вам запрещено здесь играть.
ban-banned-2 = Фрик, выдавший бан: "{ $adminName }"
ban-banned-3 = Причина бана: "{ $reason }"
ban-banned-4 = Попытки обойти блокировку будут регестрироваться и караться высшей мерой наказания!!
